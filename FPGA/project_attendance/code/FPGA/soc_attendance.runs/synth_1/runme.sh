...
HD_PWD='C:/kyh/soc_attendance/soc_attendance.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SOC_check_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SOC_check_top.tcl
