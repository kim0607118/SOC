...
HD_PWD='C:/kyh/soc_attendance/soc_attendance.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SOC_check_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SOC_check_top.tcl -notrace
