...
HD_PWD='C:/kyh/soc_fan/soc_fan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log complete.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source complete.tcl -notrace
